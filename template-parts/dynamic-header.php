		...
		<div class="sv-header__container">
			<div class="sv-header__logo">
				<a href="<?php echo home_url(); ?>" title="<?php esc_attr_e('Ir para a página inicial', 'hello-theme-child'); ?>">
					<img
						src="<?php echo $stylesheet_dir_uri; ?>/assets/images/logo-tracbel-dark.svg"
			...
			<div class="sv-header__content">
				...
				<label for="sv-header__checkbox" class="sv-header__nav-controls d-none-desktop">
					<img src="<?php echo $stylesheet_dir_uri; ?>/assets/images/menu-open.svg" alt="Abrir Menu" class="sv-header__navOpen" width="30" height="30">
					<img src="<?php echo $stylesheet_dir_uri; ?>/assets/images/menu-close.svg" alt="Fechar Menu" class="sv-header__navClose" width="30" height="30">
				</label>
				...
				<div id="search-overlay" class="search-overlay">
					<div class="search-overlay__content">
						<div class="search-overlay__form-container">
							...
							<?php get_search_form(); ?>
							<img
								src="<?php echo $stylesheet_dir_uri; ?>/assets/images/menu-close-white.svg"
								alt="Fechar Pesquisa"
